...
trainingRouter.route('/ptDetails/')
    .post(trainingController.ptDetails);

trainingRouter.route('/ptResource/')
    .delete(trainingController.ptResource)
    .post(trainingController.add_pt_resources);
